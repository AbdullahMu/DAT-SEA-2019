...
**Instructor**: [Naumaan Nayyar](https://www.linkedin.com/in/nayyarnaumaan) (naumaann@gmail.com)
...
We'll use Slack for our class communications platform. Slack is a messaging platform where you can chat with your peers and instructors. We will use Slack to share information about the course, discuss lessons, and submit projects. Our Slack homepage is [ga-seattle-part-time.slack.com](ga-seattle-part-time.slack.com) and the course channel is [dat-oct-19](dat-oct-19).
...
[Data Science Seattle - Exit Ticket](https://forms.gle/C6bcCAhVP9rbw91A8)
